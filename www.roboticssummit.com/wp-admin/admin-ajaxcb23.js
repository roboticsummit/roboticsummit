var grid = jQuery('#2891').masonry({
  itemSelector: '.scheduleday_wrapper',
  gutter: 40
});

jQuery('#2891 li .session_content_wrapper.expandable').on( 'click', function(e) {
...
jQuery('#session_filter_2891 li a').on( 'click', function(e) {
	var targetFilter = jQuery(this).attr('data-filter');
	
	jQuery('#session_filter_2891 li a').removeClass('active');
	jQuery(this).addClass('active');
	
	if(targetFilter != '')
	{
		jQuery('#2891 ul.scheduleday_wrapper li').removeClass('hide');
		
		jQuery('#2891 ul.scheduleday_wrapper li').each(function(){
...
jQuery('#session_expand_2891').on( 'click', function(e) {
	jQuery('#2891 ul.scheduleday_wrapper li .session_content_wrapper.expandable').trigger('click');
